...
export async function GET() {
  ...
  const lines = [
    ...
    `- Company: family-owned, founded and run by Miss P; more than 10 years of cleaning experience`,
    `- Equipment: all cleaning materials and equipment included; eco-friendly, biodegradable products`,
    `- Payment: at the time of service by bank transfer or credit/debit card (no cash)`,
    `- Rescheduling: please give at least 24 hours' notice`,
